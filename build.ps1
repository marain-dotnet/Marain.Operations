...
#
$ExcludeFilesFromCodeCoverage = "**/Marain.Operations.ControlClient/**/Models/*.cs,**/Marain.Operations.ControlClient/**/MarainOperationsControl*.cs,**/Marain.Operations.StatusClient/**/Models/*.cs,**/Marain.Operations.StatusClient/**/MarainOperationsStatus*.cs"
