...
Scenario: Create non-existent operation
    ...
    And the 'Location' property in the result should be 'http://operationsstatus.example.com/{transientTenantId}/api/operations/d306cb37-bc58-40fc-801c-bce5fb2c3a67'
