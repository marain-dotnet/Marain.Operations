...
public readonly partial struct UpdateTenantJsonPatchEntry
{
    ...
    {
        /// <inheritdoc/>
        public ValueEntity Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        public ValueEntity Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        public ValueEntity AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        public ValueEntity AddRange<TItem>(IEnumerable<TItem> items)
        ...
        /// <inheritdoc/>
        public ValueEntity AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.AddRange(items);
            return new(builder.ToImmutable());
        ...
        /// <inheritdoc/>
        public ValueEntity Insert(int index, in JsonAny item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }

        /// <inheritdoc/>
        public ValueEntity InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        public ValueEntity InsertRange<TItem>(int index, IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
        ...
        /// <inheritdoc/>
        public ValueEntity InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(this.GetImmutableListWith(index, items));
        }

        /// <inheritdoc/>
        public ValueEntity Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny);
        }

        /// <inheritdoc/>
        public ValueEntity SetItem(int index, in JsonAny value)
        {
