...
public readonly partial struct UpdateTenantJsonPatchEntry
{
    ...
    /// </summary>
    public readonly partial struct ValueEntity : IJsonNumber<ValueEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValueEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValueEntity(double value)
        {
        ...
        public static implicit operator JsonNumber(ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(JsonNumber value)
        {
        ...
        public static implicit operator ValueEntity(double value)
        {
            return new(value);
        }
        ...
        public static implicit operator double (ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ValueEntity(float value)
        {
            return new(value);
        }
        ...
        public static implicit operator float (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ValueEntity(int value)
        {
            return new(value);
        }
        ...
        public static implicit operator int (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ValueEntity(long value)
        {
            return new(value);
        }
        ...
        public static implicit operator long (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValueEntity(uint value)
        {
            return new(value);
        }
        ...
        public static implicit operator uint (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ValueEntity(ushort value)
        {
            return new(value);
        }
        ...
        public static implicit operator ushort (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ValueEntity(ulong value)
        {
            return new(value);
        }
        ...
        public static implicit operator ulong (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ValueEntity(byte value)
        {
            return new(value);
        }
        ...
        public static implicit operator byte (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ValueEntity(sbyte value)
        {
            return new(value);
        }
        ...
        public static implicit operator sbyte (ValueEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
