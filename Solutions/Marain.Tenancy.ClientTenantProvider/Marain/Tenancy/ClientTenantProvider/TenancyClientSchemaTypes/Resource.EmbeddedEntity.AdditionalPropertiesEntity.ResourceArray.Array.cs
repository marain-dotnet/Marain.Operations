...
public readonly partial struct Resource
{
    public readonly partial struct EmbeddedEntity
    {
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            /// </summary>
            public readonly partial struct ResourceArray : IJsonArray<ResourceArray>
            {
                /// <summary>
                /// Gets an empty array.
                /// </summary>
                public static readonly ResourceArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
                /// <summary>
                /// Initializes a new instance of the <see cref = "ResourceArray"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public ResourceArray(ImmutableList<JsonAny> value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public ResourceArray(IEnumerable<JsonAny> value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.Array;
                ...
                public static implicit operator JsonArray(ResourceArray value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator ResourceArray(JsonArray value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonAny>(ResourceArray value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator ResourceArray(ImmutableList<JsonAny> value)
                {
                    return new(value);
                }
                ...
                public static ResourceArray From(ImmutableList<JsonAny> items)
                {
                    return new(items);
                }
                ...
                /// <returns>A ResourceArray instantiated from the given items.</returns>
                public static ResourceArray FromItems(in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource value1)
                {
                ...
                /// <returns>A ResourceArray instantiated from the given items.</returns>
                public static ResourceArray FromItems(in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource value1, in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource value2)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    builder.Add(value1.AsAny);
                ...
                /// <returns>A ResourceArray instantiated from the given items.</returns>
                public static ResourceArray FromItems(in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource value1, in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource value2, in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource value3)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    builder.Add(value1.AsAny);
                    builder.Add(value2.AsAny);
                ...
                public static ResourceArray FromItems(params Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource[] value)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    foreach (Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource item in value)
                    {
                ...
                /// <param name = "value">The value from which to construct the instance.</param>
                /// <returns>A JsonAny instantiated from the given items.</returns>
                public static ResourceArray FromRange(IEnumerable<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource> value)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    foreach (Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource item in value)
                    {
                ...
                /// </remarks>
                public static ResourceArray From<T>(IEnumerable<T> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    ...
                    return new ResourceArray(builder.ToImmutable());
                }
                ...
                /// other overloads which avoid this serialization step.
                /// </remarks>
                public static ResourceArray FromRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// other overloads which avoid this serialization step.
                /// </remarks>
                public static ResourceArray FromRange<T>(IEnumerable<T> items)
                ...
                /// <inheritdoc/>
                public JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource> EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource>(this.jsonElementBacking);
                    }

                    if ((this.backing & Backing.Array) != 0)
                    {
                        return new JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource>(this.arrayBacking);
                    }
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator IJsonArray<ResourceArray>.EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator<TItem> IJsonArray<ResourceArray>.EnumerateArray<TItem>()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
