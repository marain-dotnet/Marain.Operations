...
public readonly partial struct Tenant
{
    private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext anyOfResult0 = this.As<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext anyOfResult1 = this.As<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Tenant.AnyOf1Entity>().Validate(childContext1.CreateChildContext(), level);
