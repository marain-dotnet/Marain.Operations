    ...
    public readonly partial struct EmbeddedEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext oneOfResult0 = this.As<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource>().Validate(childContext0.CreateChildContext(), level);
                ...
                ValidationContext oneOfResult1 = this.As<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource.EmbeddedEntity.AdditionalPropertiesEntity.ResourceArray>().Validate(childContext1.CreateChildContext(), level);
