...
public readonly partial struct UpdateTenantJsonPatchEntry
{
    ...
    /// </summary>
    public readonly partial struct ValueEntity : IJsonObject<ValueEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValueEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValueEntity(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
        ...
        public static implicit operator JsonObject(ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(ValueEntity value)
        {
        ...
        public static ValueEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ValueEntity FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ValueEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ValueEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ValueEntity SetProperty<TValue>(string name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public ValueEntity SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public ValueEntity SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
            where TValue : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public ValueEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public ValueEntity RemoveProperty(string name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public ValueEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public ValueEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
