...
/// </summary>
public readonly partial struct ChildTenants : IJsonObject<ChildTenants>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "ChildTenants"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public ChildTenants(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
    ...
    public static implicit operator JsonObject(ChildTenants value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ChildTenants(JsonObject value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ChildTenants(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(ChildTenants value)
    {
    ...
    public static ChildTenants FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static ChildTenants FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static ChildTenants FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public ChildTenants SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public ChildTenants SetProperty<TValue>(string name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public ChildTenants SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public ChildTenants SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
        where TValue : struct, IJsonValue
    {
    ...
    /// <inheritdoc/>
    public ChildTenants RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public ChildTenants RemoveProperty(string name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public ChildTenants RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public ChildTenants RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
