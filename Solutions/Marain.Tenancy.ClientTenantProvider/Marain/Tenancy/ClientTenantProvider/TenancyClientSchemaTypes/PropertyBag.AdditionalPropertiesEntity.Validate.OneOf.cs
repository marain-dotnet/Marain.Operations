...
public readonly partial struct PropertyBag
{
    ...
    public readonly partial struct AdditionalPropertiesEntity
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonArray>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonBoolean>().Validate(childContext1.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult2 = this.As<Corvus.Json.JsonInteger>().Validate(childContext2.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult3 = this.As<Corvus.Json.JsonNumber>().Validate(childContext3.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult4 = this.As<Corvus.Json.JsonObject>().Validate(childContext4.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult5 = this.As<Corvus.Json.JsonString>().Validate(childContext5.CreateChildContext(), level);
