...
public readonly partial struct UpdateTenantJsonPatchEntry
{
    ...
    /// </summary>
    public readonly partial struct ValueEntity : IJsonArray<ValueEntity>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ValueEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValueEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValueEntity(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValueEntity(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
            this.stringBacking = string.Empty;
        ...
        public static implicit operator JsonArray(ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ValueEntity From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static ValueEntity FromItems(params JsonAny[] value)
        {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A ValueEntity instantiated from the given items.</returns>
        public static ValueEntity FromItems<TItem>(params TItem[] value)
        ...
        /// <returns>A ValueEntity instantiated from the given items.</returns>
        public static ValueEntity FromItems<TItem1>(in TItem1 value1)
        ...
        /// <returns>A ValueEntity instantiated from the given items.</returns>
        public static ValueEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
        ...
        /// <returns>A ValueEntity instantiated from the given items.</returns>
        public static ValueEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
        ...
        /// </remarks>
        public static ValueEntity From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ValueEntity(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ValueEntity FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ValueEntity FromRange<T>(IEnumerable<T> items)
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValueEntity FromRange(IEnumerable<string> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValueEntity FromRange(IEnumerable<double> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValueEntity FromRange(IEnumerable<float> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValueEntity FromRange(IEnumerable<int> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValueEntity FromRange(IEnumerable<long> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValueEntity FromRange(IEnumerable<bool> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value1">The first value from which to construct the instance.</param>
        /// <returns>A ValueEntity instantiated from the given items.</returns>
        public static ValueEntity FromItems(in JsonAny value1)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            return new(builder.ToImmutable());
        ...
        /// <param name = "value2">The second value from which to construct the instance.</param>
        /// <returns>A ValueEntity instantiated from the given items.</returns>
        public static ValueEntity FromItems(in JsonAny value1, in JsonAny value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
        ...
        /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
        /// <returns>A ValueEntity instantiated from the given items.</returns>
        public static ValueEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
