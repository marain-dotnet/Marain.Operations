        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            public readonly partial struct ResourceArray
            {
                private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    int arrayLength = 0;
                    using JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource> arrayEnumerator = this.EnumerateArray();
                    while (arrayEnumerator.MoveNext())
                    {
                        ...
                        using JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource> innerEnumerator = this.EnumerateArray();
                        int innerIndex = -1;
