...
public readonly partial struct PropertyBag
{
    ...
    /// </summary>
    public readonly partial struct AdditionalPropertiesEntity : IJsonString<AdditionalPropertiesEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "AdditionalPropertiesEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AdditionalPropertiesEntity(string value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AdditionalPropertiesEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public AdditionalPropertiesEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(AdditionalPropertiesEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (AdditionalPropertiesEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(AdditionalPropertiesEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }
