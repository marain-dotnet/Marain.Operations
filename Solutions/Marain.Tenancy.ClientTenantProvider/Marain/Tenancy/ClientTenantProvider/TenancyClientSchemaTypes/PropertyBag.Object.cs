...
/// </summary>
public readonly partial struct PropertyBag : IJsonObject<PropertyBag>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "PropertyBag"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public PropertyBag(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
    ...
    public static implicit operator JsonObject(PropertyBag value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator PropertyBag(JsonObject value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator PropertyBag(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(PropertyBag value)
    {
    ...
    public static PropertyBag FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PropertyBag FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PropertyBag FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public PropertyBag SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public PropertyBag SetProperty<TValue>(string name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public PropertyBag SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public PropertyBag SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
        where TValue : struct, IJsonValue
    {
    ...
    /// <inheritdoc/>
    public PropertyBag RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public PropertyBag RemoveProperty(string name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public PropertyBag RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public PropertyBag RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
