...
public readonly partial struct Resource
{
    public readonly partial struct LinksEntity
    {
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            /// </summary>
            public readonly partial struct LinkArray : IJsonArray<LinkArray>
            {
                /// <summary>
                /// Gets an empty array.
                /// </summary>
                public static readonly LinkArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
                /// <summary>
                /// Initializes a new instance of the <see cref = "LinkArray"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public LinkArray(ImmutableList<JsonAny> value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public LinkArray(IEnumerable<JsonAny> value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.Array;
                ...
                public static implicit operator JsonArray(LinkArray value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator LinkArray(JsonArray value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonAny>(LinkArray value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator LinkArray(ImmutableList<JsonAny> value)
                {
                    return new(value);
                }
                ...
                public static LinkArray From(ImmutableList<JsonAny> items)
                {
                    return new(items);
                }
                ...
                /// <returns>A LinkArray instantiated from the given items.</returns>
                public static LinkArray FromItems(in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link value1)
                {
                ...
                /// <returns>A LinkArray instantiated from the given items.</returns>
                public static LinkArray FromItems(in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link value1, in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link value2)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    builder.Add(value1.AsAny);
                ...
                /// <returns>A LinkArray instantiated from the given items.</returns>
                public static LinkArray FromItems(in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link value1, in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link value2, in Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link value3)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    builder.Add(value1.AsAny);
                    builder.Add(value2.AsAny);
                ...
                public static LinkArray FromItems(params Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link[] value)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    foreach (Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link item in value)
                    {
                ...
                /// <param name = "value">The value from which to construct the instance.</param>
                /// <returns>A JsonAny instantiated from the given items.</returns>
                public static LinkArray FromRange(IEnumerable<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link> value)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    foreach (Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link item in value)
                    {
                ...
                /// </remarks>
                public static LinkArray From<T>(IEnumerable<T> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    ...
                    return new LinkArray(builder.ToImmutable());
                }
                ...
                /// other overloads which avoid this serialization step.
                /// </remarks>
                public static LinkArray FromRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// other overloads which avoid this serialization step.
                /// </remarks>
                public static LinkArray FromRange<T>(IEnumerable<T> items)
                ...
                /// <inheritdoc/>
                public JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link> EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link>(this.jsonElementBacking);
                    }

                    if ((this.backing & Backing.Array) != 0)
                    {
                        return new JsonArrayEnumerator<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link>(this.arrayBacking);
                    }
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator IJsonArray<LinkArray>.EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator<TItem> IJsonArray<LinkArray>.EnumerateArray<TItem>()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
