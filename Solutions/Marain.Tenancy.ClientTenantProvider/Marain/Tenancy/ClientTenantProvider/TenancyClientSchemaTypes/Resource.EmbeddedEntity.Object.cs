...
public readonly partial struct Resource
{
    ...
    /// </summary>
    public readonly partial struct EmbeddedEntity : IJsonObject<EmbeddedEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "EmbeddedEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EmbeddedEntity(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
        ...
        public static implicit operator JsonObject(EmbeddedEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmbeddedEntity(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmbeddedEntity(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(EmbeddedEntity value)
        {
        ...
        public static EmbeddedEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static EmbeddedEntity FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static EmbeddedEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public EmbeddedEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public EmbeddedEntity SetProperty<TValue>(string name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public EmbeddedEntity SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
            where TValue : struct, IJsonValue
        {
            return new(this.GetImmutableDictionaryWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public EmbeddedEntity SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
            where TValue : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public EmbeddedEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public EmbeddedEntity RemoveProperty(string name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public EmbeddedEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetImmutableDictionaryWithout(name));
        }

        /// <inheritdoc/>
        public EmbeddedEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
