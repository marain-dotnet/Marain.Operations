...
public readonly partial struct UpdateTenantJsonPatchEntry
{
    ...
    /// </summary>
    public readonly partial struct ValueEntity : IJsonString<ValueEntity>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValueEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public ValueEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(ValueEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValueEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }
