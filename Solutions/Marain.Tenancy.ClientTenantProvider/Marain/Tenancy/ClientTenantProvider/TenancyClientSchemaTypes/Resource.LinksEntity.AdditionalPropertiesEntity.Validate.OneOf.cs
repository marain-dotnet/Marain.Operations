    ...
    public readonly partial struct LinksEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext oneOfResult0 = this.As<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Link>().Validate(childContext0.CreateChildContext(), level);
                ...
                ValidationContext oneOfResult1 = this.As<Marain.Tenancy.ClientTenantProvider.TenancyClientSchemaTypes.Resource.LinksEntity.AdditionalPropertiesEntity.LinkArray>().Validate(childContext1.CreateChildContext(), level);
