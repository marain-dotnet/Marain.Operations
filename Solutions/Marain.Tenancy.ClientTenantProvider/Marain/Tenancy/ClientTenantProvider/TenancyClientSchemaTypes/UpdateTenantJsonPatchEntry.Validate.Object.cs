    ...
    private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        foreach (JsonObjectProperty property in this.EnumerateObject())
        {
            if (__TryGetCorvusLocalPropertiesValidator(property, this.HasJsonElementBacking, out ObjectPropertyValidator? propertyValidator))
            {
                ...
                if ((this.HasJsonElementBacking && property.NameEquals(OpUtf8JsonPropertyName.Span)) || (!this.HasJsonElementBacking && property.NameEquals(OpJsonPropertyName)))
                {
                    foundOp = true;
                }
                else if ((this.HasJsonElementBacking && property.NameEquals(PathUtf8JsonPropertyName.Span)) || (!this.HasJsonElementBacking && property.NameEquals(PathJsonPropertyName)))
                {
                    foundPath = true;
                }
            }
