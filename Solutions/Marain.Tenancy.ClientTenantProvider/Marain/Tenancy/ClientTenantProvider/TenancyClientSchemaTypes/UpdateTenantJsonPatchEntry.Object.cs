...
/// </summary>
public readonly partial struct UpdateTenantJsonPatchEntry : IJsonObject<UpdateTenantJsonPatchEntry>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "UpdateTenantJsonPatchEntry"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public UpdateTenantJsonPatchEntry(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
    ...
    public static implicit operator JsonObject(UpdateTenantJsonPatchEntry value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator UpdateTenantJsonPatchEntry(JsonObject value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator UpdateTenantJsonPatchEntry(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(UpdateTenantJsonPatchEntry value)
    {
    ...
    public static UpdateTenantJsonPatchEntry FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static UpdateTenantJsonPatchEntry FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static UpdateTenantJsonPatchEntry FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry SetProperty<TValue>(string name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
        where TValue : struct, IJsonValue
    {
    ...
    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry RemoveProperty(string name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public UpdateTenantJsonPatchEntry RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
