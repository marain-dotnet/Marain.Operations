...
public readonly partial struct Resource
{
    public readonly partial struct EmbeddedEntity
    {
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            {
                /// <inheritdoc/>
                public ResourceArray Add(in JsonAny item1)
                {
                ...
                /// <inheritdoc/>
                public ResourceArray Add(params JsonAny[] items)
                {
                    ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                ...
                /// <inheritdoc/>
                public ResourceArray AddRange<TArray>(in TArray items)
                ...
                /// <inheritdoc/>
                public ResourceArray AddRange<TItem>(IEnumerable<TItem> items)
                ...
                /// <inheritdoc/>
                public ResourceArray AddRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                    builder.AddRange(items);
                    return new(builder.ToImmutable());
                ...
                /// <inheritdoc/>
                public ResourceArray Insert(int index, in JsonAny item1)
                {
                    return new(this.GetImmutableListWith(index, item1));
                }

                /// <inheritdoc/>
                public ResourceArray InsertRange<TArray>(int index, in TArray items)
                    where TArray : struct, IJsonArray<TArray>
                {
                ...
                /// <inheritdoc/>
                public ResourceArray InsertRange<TItem>(int index, IEnumerable<TItem> items)
                    where TItem : struct, IJsonValue<TItem>
                {
                ...
                /// <inheritdoc/>
                public ResourceArray InsertRange(int index, IEnumerable<JsonAny> items)
                {
                    return new(this.GetImmutableListWith(index, items));
                }

                /// <inheritdoc/>
                public ResourceArray Replace(in JsonAny oldValue, in JsonAny newValue)
                {
                    return this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny);
                }

                /// <inheritdoc/>
                public ResourceArray SetItem(int index, in JsonAny value)
                {
